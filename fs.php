        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="#" class="active"><span class="fa-solid fa-file-code"></span>
                    ...
                    <li>
                        <a href="pyth.php"><span class="fa-brands fa-python"></span>
                            <span>PYTHON</span></a>
                    </li>
                    <li>
            ...
            <header>
                <h2>
                    <label for="nav-toggle">
                        <span class="fa-solid fa-file-code"></span>
                    </label>
                    &nbsp;&nbsp;Jobs Nearby for Full stack
                </h2>
